...
if ($MERGEDATA16 || $MERGEDATA17 || $MERGEDATA18) then
    ...
    if ($MERGEDATA16) hadd AllData/HTauTauHMuMu2016.root *2016*/HTauTauHMuMu.root >&! haddlog_${SETNAME}_mergingData.txt
    if ($MERGEDATA17) hadd AllData/HTauTauHMuMu.root *2017*/HTauTauHMuMu.root >&! haddlog_${SETNAME}_mergingData.txt
    if ($MERGEDATA18) hadd AllData/HTauTauHMuMu.root *2018*/HTauTauHMuMu.root >&! haddlog_${SETNAME}_mergingData.txt
endif
