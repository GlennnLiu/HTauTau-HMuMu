...
from HTauTauHMuMu.AnalysisStep.eostools import *
from HTauTauHMuMu.AnalysisStep.readSampleInfo import *
...
export ROOT_HIST=0
if [ -s HTauTauHMuMu.root ]; then
 root -q -b '${CMSSW_BASE}/src/HTauTauHMuMu/AnalysisStep/test/prod/rootFileIntegrity.r("HTauTauHMuMu.root")'
else
 echo moving empty file
 mv HTauTauHMuMu.root HTauTauHMuMu.root.empty
fi
...
#  cp HTauTauHMuMu.root* *.txt *.gz $OutFolder
#fi
