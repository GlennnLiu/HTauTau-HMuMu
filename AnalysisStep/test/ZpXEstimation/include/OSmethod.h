...
private:
   ...
   TGraphErrors *FR_OS_electron_EB, *FR_OS_electron_EE, *FR_OS_muon_EB, *FR_OS_muon_EE, *FR_OS_tauE_EB, *FR_OS_tauE_EE, *FR_OS_tauMu_EB, *FR_OS_tauMu_EE, *FR_OS_tauTau_EB, *FR_OS_tauTau_EE;
   TGraphErrors *FR_OS_electron_EB_unc, *FR_OS_electron_EE_unc, *FR_OS_muon_EB_unc, *FR_OS_muon_EE_unc, *FR_OS_tauE_EB_unc, *FR_OS_tauE_EE_unc, *FR_OS_tauMu_EB_unc, *FR_OS_tauMu_EE_unc, *FR_OS_tauTau_EB_unc, *FR_OS_tauTau_EE_unc;
