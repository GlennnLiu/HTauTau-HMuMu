...
private:
   ...
   int _current_process, _current_final_state, _current_category, _current_category_stxs, _n_pT_bins, _n_MET_bins, _current_pT_bin, _current_eta_bin;
   ...
   TH3F *passing[num_of_processes][num_of_flavours][3], *failing[num_of_processes][num_of_flavours][3];
   
   TH1F *FR_SS_electron_EB, *FR_SS_electron_EE, *FR_SS_muon_EB, *FR_SS_muon_EE;
   TH2F *FR_SS_tauE_Decay0[3], *FR_SS_tauE_Decay1[3], *FR_SS_tauE_Decay10[3], *FR_SS_tauE_Decay11[3], *FR_SS_tauMu_Decay0[3], *FR_SS_tauMu_Decay1[3], *FR_SS_tauMu_Decay10[3], *FR_SS_tauMu_Decay11[3], *FR_SS_tauTau_Decay0[3], *FR_SS_tauTau_Decay1[3], *FR_SS_tauTau_Decay10[3], *FR_SS_tauTau_Decay11[3];
   
   TH1F *FR_SS_electron_EB_unc, *FR_SS_electron_EE_unc, *FR_SS_muon_EB_unc, *FR_SS_muon_EE_unc;
   TH2F *FR_SS_tauE_Decay0_unc[3], *FR_SS_tauE_Decay1_unc[3], *FR_SS_tauE_Decay10_unc[3], *FR_SS_tauE_Decay11_unc[3], *FR_SS_tauMu_Decay0_unc[3], *FR_SS_tauMu_Decay1_unc[3], *FR_SS_tauMu_Decay10_unc[3], *FR_SS_tauMu_Decay11_unc[3], *FR_SS_tauTau_Decay0_unc[3], *FR_SS_tauTau_Decay1_unc[3], *FR_SS_tauTau_Decay10_unc[3], *FR_SS_tauTau_Decay11_unc[3];
