...
//    genHEPMCweight = genInfo.weight();
    ...
    event.getByToken(packedgenParticlesToken, packedgenParticles);
...
void ZNtupleMaker::FillCandidate(const pat::CompositeCandidate& cand, bool evtPass, const edm::Event& event)
{
  ...
  for (unsigned int i=0; i<leptons.size(); ++i){
    ...
    LepBDT  .push_back( lepFlav!=15 ? userdatahelpers::getUserFloat(leptons[i],"BDT") : 0.);
    ...
    LepScale_Total_Up.push_back(lepFlav!=15 ? userdatahelpers::getUserFloat(leptons[i],"scale_total_up") : -99. );
    LepScale_Total_Dn.push_back(lepFlav!=15 ? userdatahelpers::getUserFloat(leptons[i],"scale_total_dn") : -99. );
    ...
    LepSigma_Total_Up.push_back(lepFlav!=15 ? userdatahelpers::getUserFloat(leptons[i],"sigma_total_up") : -99. );
    LepSigma_Total_Dn.push_back(lepFlav!=15 ? userdatahelpers::getUserFloat(leptons[i],"sigma_total_dn") : -99. );
