#ifndef LLNtupleFactory_h
#define LLNtupleFactory_h
...
class LLNtupleFactory{
  
 
 protected:
  
 public:
  LLNtupleFactory(TTree* outTree_input, TTree* failedTree_input=0);
  ~LLNtupleFactory();
 ...
 private:
  ...
  TTree* _outTree;
  TTree* _failedTree;
  // MELABranches: Only branches are owned. Every other related object is owned by LLNtupleMaker.
