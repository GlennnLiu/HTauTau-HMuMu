...
const int num_of_fake_bkg          = 3;

class LTau: public Tree
{
...
public:
    ...
    void SetFileList(string*,int,string*,int,string*,int,string*,int);
    ...
    void Step3_WJ_FakeRate_DeclareHistos();
    void Step3_WJ_FakeRate_FillHistos();
    void Step3_WJ_FakeRate_Compute();
    void Step3_WJ_FakeRate_SaveHistos();
    void Step3_WJ_FakeRate_GetHistos();

    void Step3_WJ_Closure_DeclareHistos();
    void Step3_WJ_Closure_FillHistos();
    void Step3_WJ_Closure_Compute();
    void Step3_WJ_Closure_SaveHistos();
    void Step3_WJ_Closure_GetHistos();

    void Step3_WJ_vsSR_DeclareHistos();
    void Step3_WJ_vsSR_FillHistos();
    void Step3_WJ_vsSR_Compute();
    void Step3_WJ_vsSR_SaveHistos();
    void Step3_WJ_vsSR_GetHistos();
...
private:
    ...
    vector<string> _dataFiles, _MCBkgFiles, _WJFiles, _TTFiles;
    vector<string> _s_process, _s_final_state, _s_categories, _s_fake_bkg, _s_variables;
    int _current_process, _current_final_state, _current_category, _current_njet_bin, _current_taupt_bin, _pass, _current_trg;
    float _lumi, _k_factor;
    double gen_sum_weights, _event_weight; 

    float _taupt_bins[99], _lpt_bins[99], _Mvis_bins[99], _MT_bins[99], _DR_bins[99];
    int _n_taupt_bins, _n_lpt_bins, _n_Mvis_bins, _n_MT_bins, _n_DR_bins;
    ...
    //step 2
    TH1F *hClosure[num_of_fake_bkg][num_of_final_states][num_of_taupt_bins][2];
    TH1F *hClosure_FR[num_of_fake_bkg][num_of_final_states][num_of_taupt_bins];
    TF1 *fClosure_FR[num_of_fake_bkg][num_of_final_states][num_of_taupt_bins];
    ...
    TH1F *hQCDClosure[num_of_final_states][num_of_taupt_bins][2];
    TH1F *hQCDClosure_FR[num_of_final_states][num_of_taupt_bins];
    TF1 *fQCDClosure_FR[num_of_final_states][num_of_taupt_bins];
    ...
    //step 3.2 WJ
    TH1F *hWJ[num_of_final_states][num_of_njet_bins][2];
    TH1F *hWJ_FR[num_of_final_states][num_of_njet_bins];
    TF1 *fWJ_FR[num_of_final_states][num_of_njet_bins];

    TH1F *hWJClosure[num_of_final_states][num_of_taupt_bins][2];
    TH1F *hWJClosure_FR[num_of_final_states][num_of_taupt_bins];
    TF1 *fWJClosure_FR[num_of_final_states][num_of_taupt_bins];

    TH1F *hWJvsSR[num_of_final_states][2];
    TH1F *hWJvsSR_FR[num_of_final_states];
    TF1 *fWJvsSR_FR[num_of_final_states];
