...
// Constructor
SVfit::SVfit (int verbosity, TLorentzVector tau1, TLorentzVector tau2, TLorentzVector met, TMatrixD met_cov, int pairType, int DM1, int DM2)
{
  if (DEBUG)
  {
...
// FitAndGetResult
std::vector<double> SVfit::FitAndGetResult()
{
