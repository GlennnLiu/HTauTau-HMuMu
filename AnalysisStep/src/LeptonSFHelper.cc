...
LeptonSFHelper::LeptonSFHelper(bool preVFP)
{
   ...
   if(preVFP)
   {  //ID
      TString fipEleNotCracks_2016 = Form("$CMSSW_BASE/src/HTauTauHMuMu/AnalysisStep/data/LeptonEffScaleFactors/ElectronSF_UL2016preVFP_nogap.root");
      root_file = TFile::Open(fipEleNotCracks_2016.Data(),"READ");
      h_Ele_notCracks_2016 = (TH2F*) root_file->Get("EGamma_SF2D")->Clone();

      TString fipEleCracks_2016 = Form("$CMSSW_BASE/src/HTauTauHMuMu/AnalysisStep/data/LeptonEffScaleFactors/ElectronSF_UL2016preVFP_gap.root");
      root_file = TFile::Open(fipEleCracks_2016.Data(),"READ");
      h_Ele_Cracks_2016 = (TH2F*) root_file->Get("EGamma_SF2D")->Clone();

      //RECO
      TString fipEleReco_highPt_2016 = Form("$CMSSW_BASE/src/HTauTauHMuMu/AnalysisStep/data/LeptonEffScaleFactors/egammaEffi_ptAbove20.txt_EGM2D_UL2016preVFP.root");
      root_file = TFile::Open(fipEleReco_highPt_2016.Data(),"READ");
      h_Ele_Reco_highPT_2016 = (TH2F*) root_file->Get("EGamma_SF2D")->Clone();

      TString fipEleReco_lowPt_2016 = Form("$CMSSW_BASE/src/HTauTauHMuMu/AnalysisStep/data/LeptonEffScaleFactors/egammaEffi_ptBelow20.txt_EGM2D_UL2016preVFP.root");
   ...
   {  //ID
      TString fipEleNotCracks_2016 = Form("$CMSSW_BASE/src/HTauTauHMuMu/AnalysisStep/data/LeptonEffScaleFactors/ElectronSF_UL2016postVFP_nogap.root");
      root_file = TFile::Open(fipEleNotCracks_2016.Data(),"READ");
      h_Ele_notCracks_2016 = (TH2F*) root_file->Get("EGamma_SF2D")->Clone();

      TString fipEleCracks_2016 = Form("$CMSSW_BASE/src/HTauTauHMuMu/AnalysisStep/data/LeptonEffScaleFactors/ElectronSF_UL2016postVFP_gap.root");
      root_file = TFile::Open(fipEleCracks_2016.Data(),"READ");
      h_Ele_Cracks_2016 = (TH2F*) root_file->Get("EGamma_SF2D")->Clone();

      //RECO
      TString fipEleReco_highPt_2016 = Form("$CMSSW_BASE/src/HTauTauHMuMu/AnalysisStep/data/LeptonEffScaleFactors/egammaEffi_ptAbove20.txt_EGM2D_UL2016postVFP.root");
      root_file = TFile::Open(fipEleReco_highPt_2016.Data(),"READ");
      h_Ele_Reco_highPT_2016 = (TH2F*) root_file->Get("EGamma_SF2D")->Clone();

      TString fipEleReco_lowPt_2016 = Form("$CMSSW_BASE/src/HTauTauHMuMu/AnalysisStep/data/LeptonEffScaleFactors/egammaEffi_ptBelow20.txt_EGM2D_UL2016postVFP.root");
      root_file = TFile::Open(fipEleReco_lowPt_2016.Data(),"READ");
      h_Ele_Reco_lowPT_2016 = (TH2F*) root_file->Get("EGamma_SF2D")->Clone();
   ...
   // 2017 Electrons
   TString fipEleNotCracks_2017 = Form("$CMSSW_BASE/src/HTauTauHMuMu/AnalysisStep/data/LeptonEffScaleFactors/ElectronSF_UL2017_nogap.root");
   root_file = TFile::Open(fipEleNotCracks_2017.Data(),"READ");
   h_Ele_notCracks_2017 = (TH2F*) root_file->Get("EGamma_SF2D")->Clone();

   TString fipEleCracks_2017 = Form("$CMSSW_BASE/src/HTauTauHMuMu/AnalysisStep/data/LeptonEffScaleFactors/ElectronSF_UL2017_gap.root");
   root_file = TFile::Open(fipEleCracks_2017.Data(),"READ");
   h_Ele_Cracks_2017 = (TH2F*) root_file->Get("EGamma_SF2D")->Clone();
   //RECO
   TString fipEleReco_highPt_2017 = Form("$CMSSW_BASE/src/HTauTauHMuMu/AnalysisStep/data/LeptonEffScaleFactors/egammaEffi_ptAbove20.txt_EGM2D_UL2017.root");
   root_file = TFile::Open(fipEleReco_highPt_2017.Data(),"READ");
   h_Ele_Reco_highPT_2017 = (TH2F*) root_file->Get("EGamma_SF2D")->Clone();

   TString fipEleReco_lowPt_2017 = Form("$CMSSW_BASE/src/HTauTauHMuMu/AnalysisStep/data/LeptonEffScaleFactors/egammaEffi_ptBelow20.txt_EGM2D_UL2017.root");
   root_file = TFile::Open(fipEleReco_lowPt_2017.Data(),"READ");
   h_Ele_Reco_lowPT_2017 = (TH2F*) root_file->Get("EGamma_SF2D")->Clone();


   // 2018 Electrons
   TString fipEleNotCracks_2018 = Form("$CMSSW_BASE/src/HTauTauHMuMu/AnalysisStep/data/LeptonEffScaleFactors/ElectronSF_UL2018_nogap.root");
   root_file = TFile::Open(fipEleNotCracks_2018.Data(),"READ");
   h_Ele_notCracks_2018 = (TH2F*) root_file->Get("EGamma_SF2D")->Clone();

   TString fipEleCracks_2018 = Form("$CMSSW_BASE/src/HTauTauHMuMu/AnalysisStep/data/LeptonEffScaleFactors/ElectronSF_UL2018_gap.root");
   root_file = TFile::Open(fipEleCracks_2018.Data(),"READ");
   h_Ele_Cracks_2018 = (TH2F*) root_file->Get("EGamma_SF2D")->Clone();
   //RECO
   TString fipEleReco_highPt_2018 = Form("$CMSSW_BASE/src/HTauTauHMuMu/AnalysisStep/data/LeptonEffScaleFactors/egammaEffi_ptAbove20.txt_EGM2D_UL2018.root");
   root_file = TFile::Open(fipEleReco_highPt_2018.Data(),"READ");
   h_Ele_Reco_highPT_2018 = (TH2F*) root_file->Get("EGamma_SF2D")->Clone();

   TString fipEleReco_lowPt_2018 = Form("$CMSSW_BASE/src/HTauTauHMuMu/AnalysisStep/data/LeptonEffScaleFactors/egammaEffi_ptBelow20.txt_EGM2D_UL2018.root");
   root_file = TFile::Open(fipEleReco_lowPt_2018.Data(),"READ");
   h_Ele_Reco_lowPT_2018 = (TH2F*) root_file->Get("EGamma_SF2D")->Clone();

   // 2016 Muons
   TString fipMu_2016 = Form("$CMSSW_BASE/src/HTauTauHMuMu/AnalysisStep/data/LeptonEffScaleFactors/final_HZZ_SF_2016UL_mupogsysts_newLoose.root");
   //final_HZZ_SF_2016_legacy_mupogsysts.root"); //"$CMSSW_BASE/src/HTauTauHMuMu/AnalysisStep/data/LeptonEffScaleFactors/ScaleFactors_mu_Moriond2017_v2.root");
   ...
   // 2017 Muons
   TString fipMu_2017 = Form("$CMSSW_BASE/src/HTauTauHMuMu/AnalysisStep/data/LeptonEffScaleFactors/final_HZZ_SF_2017UL_mupogsysts_newLoose.root");
   //final_HZZ_SF_2017_rereco_mupogsysts_3010.root"); //"$CMSSW_BASE/src/HTauTauHMuMu/AnalysisStep/data/LeptonEffScaleFactors/ScaleFactors_mu_Moriond2018_final.root");
   ...
   // 2018 Muons
   TString fipMu_2018 = Form("$CMSSW_BASE/src/HTauTauHMuMu/AnalysisStep/data/LeptonEffScaleFactors/final_HZZ_SF_2018UL_mupogsysts_newLoose.root"); 
   //final_HZZ_SF_2018_rereco_mupogsysts_3010.root"); //"$CMSSW_BASE/src/HTauTauHMuMu/AnalysisStep/data/LeptonEffScaleFactors/final_HZZ_muon_SF_2018RunA2D_ER_2702.root");
