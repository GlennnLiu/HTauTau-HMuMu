...
{
   // 2016 Electrons
   TString fipEleNotCracks_2016 = Form("$CMSSW_BASE/src/HTauTauHMuMu/AnalysisStep/data/LeptonEffScaleFactors/ElectronSF_Legacy_2016_NoGap.root");
   root_file = TFile::Open(fipEleNotCracks_2016.Data(),"READ");
   h_Ele_notCracks_2016 = (TH2F*) root_file->Get("EGamma_SF2D")->Clone();
      
   TString fipEleCracks_2016 = Form("$CMSSW_BASE/src/HTauTauHMuMu/AnalysisStep/data/LeptonEffScaleFactors/ElectronSF_Legacy_2016_Gap.root");
   root_file = TFile::Open(fipEleCracks_2016.Data(),"READ");
   h_Ele_Cracks_2016 = (TH2F*) root_file->Get("EGamma_SF2D")->Clone();
   
   TString fipEleReco_highPt_2016 = Form("$CMSSW_BASE/src/HTauTauHMuMu/AnalysisStep/data/LeptonEffScaleFactors/Ele_Reco_2016.root");
   root_file = TFile::Open(fipEleReco_highPt_2016.Data(),"READ");
   h_Ele_Reco_highPT_2016 = (TH2F*) root_file->Get("EGamma_SF2D")->Clone();
      
   TString fipEleReco_lowPt_2016 = Form("$CMSSW_BASE/src/HTauTauHMuMu/AnalysisStep/data/LeptonEffScaleFactors/Ele_Reco_LowEt_2016.root");
   root_file = TFile::Open(fipEleReco_lowPt_2016.Data(),"READ");
   h_Ele_Reco_lowPT_2016 = (TH2F*) root_file->Get("EGamma_SF2D")->Clone();
   
   // 2017 Electrons
   TString fipEleNotCracks_2017 = Form("$CMSSW_BASE/src/HTauTauHMuMu/AnalysisStep/data/LeptonEffScaleFactors/ElectronSF_Legacy_2017_NoGap.root");
   root_file = TFile::Open(fipEleNotCracks_2017.Data(),"READ");
   h_Ele_notCracks_2017 = (TH2F*) root_file->Get("EGamma_SF2D")->Clone();
   
   TString fipEleCracks_2017 = Form("$CMSSW_BASE/src/HTauTauHMuMu/AnalysisStep/data/LeptonEffScaleFactors/ElectronSF_Legacy_2017_Gap.root");
   root_file = TFile::Open(fipEleCracks_2017.Data(),"READ");
   h_Ele_Cracks_2017 = (TH2F*) root_file->Get("EGamma_SF2D")->Clone();
   
   TString fipEleReco_highPt_2017 = Form("$CMSSW_BASE/src/HTauTauHMuMu/AnalysisStep/data/LeptonEffScaleFactors/Ele_Reco_2017.root");
   root_file = TFile::Open(fipEleReco_highPt_2017.Data(),"READ");
   h_Ele_Reco_highPT_2017 = (TH2F*) root_file->Get("EGamma_SF2D")->Clone();
   
   TString fipEleReco_lowPt_2017 = Form("$CMSSW_BASE/src/HTauTauHMuMu/AnalysisStep/data/LeptonEffScaleFactors/Ele_Reco_LowEt_2017.root");
   root_file = TFile::Open(fipEleReco_lowPt_2017.Data(),"READ");
   h_Ele_Reco_lowPT_2017 = (TH2F*) root_file->Get("EGamma_SF2D")->Clone();
      

   // 2018 Electrons
   TString fipEleNotCracks_2018 = Form("$CMSSW_BASE/src/HTauTauHMuMu/AnalysisStep/data/LeptonEffScaleFactors/ElectronSF_Legacy_2018_NoGap.root");
   root_file = TFile::Open(fipEleNotCracks_2018.Data(),"READ");
   h_Ele_notCracks_2018 = (TH2F*) root_file->Get("EGamma_SF2D")->Clone();
   
   TString fipEleCracks_2018 = Form("$CMSSW_BASE/src/HTauTauHMuMu/AnalysisStep/data/LeptonEffScaleFactors/ElectronSF_Legacy_2018_Gap.root");
   root_file = TFile::Open(fipEleCracks_2018.Data(),"READ");
   h_Ele_Cracks_2018 = (TH2F*) root_file->Get("EGamma_SF2D")->Clone();
   
   TString fipEleReco_highPt_2018 = Form("$CMSSW_BASE/src/HTauTauHMuMu/AnalysisStep/data/LeptonEffScaleFactors/Ele_Reco_2018.root");
   root_file = TFile::Open(fipEleReco_highPt_2018.Data(),"READ");
   h_Ele_Reco_highPT_2018 = (TH2F*) root_file->Get("EGamma_SF2D")->Clone();
   
   TString fipEleReco_lowPt_2018 = Form("$CMSSW_BASE/src/HTauTauHMuMu/AnalysisStep/data/LeptonEffScaleFactors/Ele_Reco_LowEt_2018.root");
   root_file = TFile::Open(fipEleReco_lowPt_2018.Data(),"READ");
   h_Ele_Reco_lowPT_2018 = (TH2F*) root_file->Get("EGamma_SF2D")->Clone();
   
   // 2016 Muons
   TString fipMu_2016 = Form("$CMSSW_BASE/src/HTauTauHMuMu/AnalysisStep/data/LeptonEffScaleFactors/final_HZZ_muon_SF_2016RunB2H_legacy_newLoose_newIso_paper.root"); 
   ...
   // 2017 Muons
   TString fipMu_2017 = Form("$CMSSW_BASE/src/HTauTauHMuMu/AnalysisStep/data/LeptonEffScaleFactors/final_HZZ_muon_SF_2017_newLooseIso_mupogSysts_paper.root"); 
   ...
   // 2018 Muons
   TString fipMu_2018 = Form("$CMSSW_BASE/src/HTauTauHMuMu/AnalysisStep/data/LeptonEffScaleFactors/final_HZZ_muon_SF_2018RunA2D_ER_newLoose_newIso_paper.root"); 
