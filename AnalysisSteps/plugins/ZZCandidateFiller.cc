...
#include <HTauTau-HMuMu/AnalysisStep/interface/CutSet.h>
...
#include <HTauTau-HMuMu/AnalysisStep/interface/CompositeCandMassResolution.h>

#include <HTauTau-HMuMu/AnalysisStep/interface/Fisher.h>
#include <HTauTau-HMuMu/AnalysisStep/interface/Comparators.h>
  ...
  kinZfitter(0)
{
  ...
  if (setup < 2015) {// FIXME:  EbE corrections to be updated for Run II
    ...
    edm::FileInPath fip("HTauTau-HMuMu/AnalysisStep/data/ebeOverallCorrections.Legacy2013.v0.root");
