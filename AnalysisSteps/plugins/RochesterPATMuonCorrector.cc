...
#include <HTauTau-HMuMu/AnalysisStep/plugins/RoccoR.h>
...
{
  stringstream ss;
  ss << "HTauTau-HMuMu/AnalysisStep/data/RochesterCorrections/" << identifier_ << ".txt";
  string path_string = ss.str();
  edm::FileInPath corrPath("HTauTau-HMuMu/AnalysisStep/data/RochesterCorrections/"+identifier_+".txt");
