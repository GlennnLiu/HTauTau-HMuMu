...
#include <HTauTau-HMuMu/AnalysisStep/interface/PhotonFwd.h>
...
void CompositeCandMassResolution::fillP3Covariance(const reco::GsfElectron &c, TMatrixDSym &bigCov, int offset) const {
    ...
    if (c.ecalDriven()) {
        ...
        // http://cmssw.cvs.cern.ch/cgi-bin/cmssw.cgi/UserCode/CJLST/HTauTau-HMuMu/AnalysisStep/src/ZZMassErrors.cc?revision=1.2&view=markup
