...
PileUpWeight::PileUpWeight(int MC, int target) { 
 ...
 {
    edm::FileInPath fip("HTauTau-HMuMu/AnalysisStep/data/PileUpWeights/pu_weights_2016.root");
 ...
 {
		edm::FileInPath fip("HTauTau-HMuMu/AnalysisStep/data/PileUpWeights/pu_weights_2017.root");
 ...
 {
		edm::FileInPath fip("HTauTau-HMuMu/AnalysisStep/data/PileUpWeights/pu_weights_2018.root");
