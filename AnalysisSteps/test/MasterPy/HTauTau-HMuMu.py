...
from HTauTau-HMuMu.AnalysisStep.defaults import *
import os, sys
...
# Create a photon collection; cfg extracted from "UFHHTauTau-HMuMuRun2.FSRPhotons.fsrPhotons_cff"
...
if (LEPTON_SETUP == 2016): #DeepCSV, from https://twiki.cern.ch/twiki/bin/viewauth/CMS/BtagRecommendation2016Legacy
   ...
   theBTagSFFile="HTauTau-HMuMu/AnalysisStep/data/BTagging/DeepCSV_2016LegacySF_V1.csv"
   theBTagMCEffFile="HTauTau-HMuMu/AnalysisStep/data/BTagging/bTagEfficiencies_2016_LegacyPaper.root"
elif (LEPTON_SETUP == 2017): #DeepCSV, from https://twiki.cern.ch/twiki/bin/viewauth/CMS/BtagRecommendation94X
   theBTagger="pfDeepCSVJetTags:probb"
   theBTaggerThr=0.4941
   theBTagSFFile="HTauTau-HMuMu/AnalysisStep/data/BTagging/DeepCSV_94XSF_V4_B_F.csv"
   theBTagMCEffFile="HTauTau-HMuMu/AnalysisStep/data/BTagging/bTagEfficiencies_2017_LegacyPaper.root"
   ...
   theBTagSFFile="HTauTau-HMuMu/AnalysisStep/data/BTagging/DeepCSV_102XSF_V1.csv"
   theBTagMCEffFile="HTauTau-HMuMu/AnalysisStep/data/BTagging/bTagEfficiencies_2018_LegacyPaper.root" 
else:
...
process.QGPoolDBESSource = cms.ESSource("PoolDBESSource",
      ...
      connect = cms.string('sqlite_fip:HTauTau-HMuMu/AnalysisStep/data/QGTagging/QGL_'+qgDatabaseVersion+'.db')
)
...
if (APPLYJEC and SAMPLE_TYPE == 2016):
    if IsMC:
        ...
        connect = cms.string('sqlite_fip:HTauTau-HMuMu/AnalysisStep/data/JEC/Summer16_07Aug2017_V11_MC.db'),             )
    else:
        process.jec = cms.ESSource("PoolDBESSource",
            DBParameters = cms.PSet(
                messageLevel = cms.untracked.int32(1)
            ...
            connect = cms.string('sqlite_fip:HTauTau-HMuMu/AnalysisStep/data/JEC/Summer16_07Aug2017All_V11_DATA.db'),
            )
    ...
    if IsMC:
        process.jec = cms.ESSource("PoolDBESSource",
            ...
            toGet = cms.VPSet(
              ...
              connect = cms.string('sqlite_fip:HTauTau-HMuMu/AnalysisStep/data/JEC/Fall17_17Nov2017_V32_94X_MC.db'),
            )
    else:
        process.jec = cms.ESSource("PoolDBESSource",
            DBParameters = cms.PSet(
            ...
            connect = cms.string('sqlite_fip:HTauTau-HMuMu/AnalysisStep/data/JEC/Fall17_17Nov2017_V32_94X_DATA.db'),
            )
    ...
    if IsMC:
        process.jec = cms.ESSource("PoolDBESSource",
            ...
            toGet = cms.VPSet(
              ...
              connect = cms.string('sqlite_fip:HTauTau-HMuMu/AnalysisStep/data/JEC/Autumn18_V19_MC.db'), #for 10_2_X MC
            )
        ...
        process.jec = cms.ESSource("PoolDBESSource",
            ...
            connect = cms.string('sqlite_fip:HTauTau-HMuMu/AnalysisStep/data/JEC/Autumn18_RunABCD_V19_DATA.db'),
            )
...
if (APPLYJER and SAMPLE_TYPE == 2016):
   ...
   process.jer = cms.ESSource("PoolDBESSource",
                                 CondDBSetup,
                                 connect = cms.string('sqlite_fip:HTauTau-HMuMu/AnalysisStep/data/JER/Summer16_25nsV1_MC.db'),
                                 toGet = cms.VPSet(
                                                   cms.PSet(
...
if (APPLYJER and SAMPLE_TYPE == 2017):
   ...
   process.jer = cms.ESSource("PoolDBESSource",
                                 CondDBSetup,
                                 connect = cms.string('sqlite_fip:HTauTau-HMuMu/AnalysisStep/data/JER/Fall17_V3_94X_MC.db'),
                                 toGet = cms.VPSet(
                                                   cms.PSet(
                                                            record = cms.string('JetResolutionRcd'),
...
if (APPLYJER and SAMPLE_TYPE == 2018):
    ...
    process.jer = cms.ESSource("PoolDBESSource",
                               CondDBSetup,
                               #connect = cms.string('sqlite_fip:HTauTau-HMuMu/AnalysisStep/data/JER/Autumn18_V1_MC.db'),
                               connect = cms.string('sqlite_fip:HTauTau-HMuMu/AnalysisStep/data/JER/Autumn18_V7_MC.db'),
                               toGet = cms.VPSet(
                                                 cms.PSet(
                                                          record = cms.string('JetResolutionRcd'),
...
#process.load("HTauTau-HMuMu.AnalysisStep.Skim2012_cfg")
...
if (ADDLOOSEELE) :
    import os
    execfile(os.environ['CMSSW_BASE'] + "/src/HTauTau-HMuMu/AnalysisStep/test/MasterPy/LooseEle.py")
#    execfile(os.environ['CMSSW_BASE'] + "/src/HTauTau-HMuMu/AnalysisStep/test/MasterPy/TracklessEle.py")
