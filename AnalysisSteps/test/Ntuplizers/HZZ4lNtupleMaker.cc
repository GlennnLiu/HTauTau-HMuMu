...
#include <HTauTau-HMuMu/AnalysisStep/interface/METCorrectionHandler.h>
...
#include "HTauTau-HMuMu/AnalysisStep/src/kFactors.C"
#include <HTauTau-HMuMu/AnalysisStep/interface/bitops.h>
#include <HTauTau-HMuMu/AnalysisStep/interface/Fisher.h>
#include <HTauTau-HMuMu/AnalysisStep/interface/LeptonIsoHelper.h>
#include <HTauTau-HMuMu/AnalysisStep/interface/PhotonIDHelper.h>
#include <HTauTau-HMuMu/AnalysisStep/interface/JetCleaner.h>
#include <HTauTau-HMuMu/AnalysisStep/interface/utils.h>
#include <HTauTau-HMuMu/AnalysisStep/interface/miscenums.h>
  ...
  printedLHEweightwarning(false)
{
  ...
  edm::FileInPath ewkFIP("HTauTau-HMuMu/AnalysisStep/data/kfactors/ZZ_EwkCorrections.dat");
  ...
  edm::FileInPath ggzzFIP_NNLO("HTauTau-HMuMu/AnalysisStep/data/kfactors/Kfactor_Collected_ggHZZ_2l2l_NNLO_NNPDF_NarrowWidth_13TeV.root");
  ...
  edm::FileInPath ggzzFIP_NLO("HTauTau-HMuMu/AnalysisStep/data/kfactors/Kfactor_Collected_ggHZZ_2l2l_NLO_NNPDF_NarrowWidth_13TeV.root");
  ...
  edm::FileInPath NNLOPS_weight_path("HTauTau-HMuMu/AnalysisStep/data/ggH_NNLOPS_Weights/NNLOPS_reweight.root");
  ...
  if (!skipHqTWeight) {
    //HqT weights
    edm::FileInPath HqTfip("HTauTau-HMuMu/AnalysisStep/test/Macros/HqTWeights.root");
  ...
  if (!skipFakeWeight) {
    //CR fake rate weight
    TString filename;filename.Form("HTauTau-HMuMu/AnalysisStep/test/Macros/FR2_2011_AA_electron.root");
    if(year==2015)filename.Form("HTauTau-HMuMu/AnalysisStep/test/Macros/FR2_AA_ControlSample_ABCD.root");
    ...
    filename.Form("HTauTau-HMuMu/AnalysisStep/test/Macros/FR2_2011_AA_muon.root");
    if(year==2015)filename.Form("HTauTau-HMuMu/AnalysisStep/test/Macros/FR2_AA_muon.root");
